...
class AuthNavigation extends StatefulWidget {
  ...
  final WidgetBuilder? onboarding; //Onboarding -> .. ->
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthNavigationBloc, AuthNavigationState>(
      ...
      builder: (context, state) {
        ...
        } else if (state is Maintenance && widget.maintenanceBuilder != null) {
          return widget.maintenanceBuilder!(context);
        } else if (state is GuestMode && widget.guestBuilder != null) {
          return widget.guestBuilder!(context);
        } else if (state is Onboarding && widget.onboarding != null) {
          return widget.onboarding!(context);
        }
        return Container();
      },
